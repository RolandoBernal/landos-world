(() => {
  ...
  function recordMeaningFingerprint(record = {}) {
    ...
    return [
      ...
      source.rawCarbDose ?? '',
      source.rawAggregateDose ?? '',
      source.roundedBaseDose ?? '',
      source.temporaryEatingAdjustmentApplied ?? '',
      source.temporaryEatingAdjustmentUnits ?? '',
      source.temporaryEatingAdjustmentMessage ?? '',
