...
test('service worker uses separate versioned caches and strategy-specific runtime handling', () => {
  assert.match(sw, /const SW_VERSION = '2026-09-09-4'/);
...
test('app dropdowns use padded custom select arrows', () => {
  [
    ...
    [html, /css\/lee-lee-diabetes\.css\?v=20260909-4/],
    [html, /js\/lee-lees-tracker-sync\.js\?v=20260909-4/],
    [html, /js\/lee-lee-diabetes-tracker\.js\?v=20260909-4/],
