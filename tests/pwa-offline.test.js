...
test('service worker uses separate versioned caches and strategy-specific runtime handling', () => {
  assert.match(sw, /const SW_VERSION = '2026-09-15-10'/);
...
test('app dropdowns use padded custom select arrows', () => {
  [
    ...
    [html, /css\/violet-futbol-game-tracker\.css\?v=20260915-10/],
    [html, /js\/violet-futbol-game-tracker\.js\?v=20260915-10/],
